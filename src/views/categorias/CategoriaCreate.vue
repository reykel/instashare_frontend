<template>
    ...
    <div class="surface-card p-4 shadow-2 border-round">
        <div class="text-3xl font-medium text-900 m-5">Add a new Category</div>
                        ...
                        <div class="col-sm-6 mt-4">
                            ...
                            <form @submit.prevent="saveModel">
                                <div class="form-group" style="margin:3rem;">
                                    ...
                                    <InputText id="descripcion" v-model="form.descripcion" type="text" class="w-full mb-3" placeholder="Category name" style="padding:1rem;" />     
...
export default {
    setup() {
        ...
        const { errors, storeCategoria } = useCategorias()

        const saveModel = async () => {
            await storeCategoria({...form})
        }
